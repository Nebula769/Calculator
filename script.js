...
function evaluate() {
    ...
    switch (curOperator) {
        case '+':
            inputField.value = parseFloat(add(parseFloat(num1), parseFloat(curNum)).toPrecision(4));
            break;
        
        case '-':
            inputField.value = parseFloat(subtract(parseFloat(num1), parseFloat(curNum)).toPrecision(4));
            break;

        case '*':
            inputField.value = parseFloat(multiply(parseFloat(num1), parseFloat(curNum)).toPrecision(4));
            break;
        ...
        case '/':
            ...
            inputField.value = parseFloat(divide(parseFloat(num1), parseFloat(curNum)).toPrecision(4));
            break;
    }
